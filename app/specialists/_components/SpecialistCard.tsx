  ...
  return (
    <div className='w-full space-y-5 rounded-2xl bg-white p-5 shadow-md shadow-gray'>
      <Link
        ...
        className='inline-block h-[20rem] w-full overflow-hidden rounded-xl shadow-md shadow-gray'
      >
        <Image
          ...
          height={720}
          priority
          className='h-full w-full object-cover brightness-75 duration-300 hover:scale-125 hover:brightness-100'
        />
      </Link>
